...
{
    private List<Libreria> vg_lista_librerias;
    ...
    private float vg_firma_visible_xp;
    private float vg_firma_visible_yp;
    private float vg_firma_visible_x1p;
    private float vg_firma_visible_y1p;
    
    private boolean conCarmpoArea;
    ...
    public void setVg_firma_visible_y1p(float vg_firma_visible_y1p)
    {
        this.vg_firma_visible_y1p = vg_firma_visible_y1p;
    }

    public void setVg_firma_visible_xp(float vg_firma_visible_xp)
    {
        this.vg_firma_visible_xp = vg_firma_visible_xp;
    }

    public void setVg_firma_visible_yp(float vg_firma_visible_yp)
    {
        this.vg_firma_visible_yp = vg_firma_visible_yp;
    }

    public void setVg_firma_visible_x1p(float vg_firma_visible_x1p)
    {
        this.vg_firma_visible_x1p = vg_firma_visible_x1p;
    }

    public float getVg_firma_visible_xp()
    {
        return vg_firma_visible_xp;
    }

    public float getVg_firma_visible_yp()
    {
        return vg_firma_visible_yp;
    }

    public float getVg_firma_visible_x1p()
    {
        return vg_firma_visible_x1p;
    }

    public float getVg_firma_visible_y1p()
    {
        return vg_firma_visible_y1p;
    }    
    ...
    public List<Libreria> getVg_lista_librerias() {
        return vg_lista_librerias;
    }

    public void setVg_lista_librerias(List<Libreria> vg_lista_librerias) {
        this.vg_lista_librerias = vg_lista_librerias;
    }
    ...
    public void setVg_carpeta_salida_crl_tsl(String vg_carpeta_salida_crl_tsl) {
        this.vg_carpeta_salida_crl_tsl = vg_carpeta_salida_crl_tsl;
    }
    ...
    public Firma getFirmaDefecto() {
        return firmaDefecto;
    }

    public void setFirmaDefecto(Firma firmaDefecto) {
        this.firmaDefecto = firmaDefecto;
    }
