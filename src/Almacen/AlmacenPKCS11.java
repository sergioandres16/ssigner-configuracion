...
public class AlmacenPKCS11  implements  AlmacenProveedor{
    ...
    @Override
    public KeyStore RecuperarAlmacen(char[] pin, String pLibreria) throws KeyStoreException {
         PKCS11 p11 = null;
        long hSession = -1;
...
//            libreria_proveedor.remove(libreria_ruta.getName());
            ...
            p11 = PKCS11.getInstance(libreria.getAbsolutePath(), "C_GetFunctionsList", initArgs, false);
...
//            p11.C_CloseSession(hSession);
            ...
            ks.load(new FileInputStream(libreria),pin);
            configStream.close();
            return ks;
            ...
            switch (ex.getMessage()) {
                ...
                case "CKR_TOKEN_NOT_RECOGNIZED":
                  try {
                    ...
                    Logger.getLogger(Almacen.AlmacenPKCS11.class.getName()).log(Level.SEVERE, null, ex1);
                ...
                default:
                    ...
                    Logger.getLogger(Almacen.AlmacenPKCS11.class.getName()).log(Level.SEVERE, null, ex.getMessage());
            }
        } catch (NoSuchAlgorithmException ex) {
            new CLog().archivar_log(ex.getMessage());
            Logger.getLogger(Almacen.AlmacenPKCS11.class.getName()).log(Level.SEVERE, null, ex);
...
//            windowsDir_iKey="name = SmartCard\n" + "library = "+file.getPath()+"\nslot=3\nshowInfo=true";///home/christofer/Escritorio/libacsccid.so";// Archivo+
//            PKCS11_CONFIG_IKEY  = windowsDir_iKey.getBytes();
//            ByteArrayInputStream configStream = new ByteArrayInputStream(PKCS11_CONFIG_IKEY);
//            Provider sunPKCS11Provider = this.createSunPKCS11Provider(configStream);          
//            if (Security.getProvider(sunPKCS11Provider.getName())!=null) // Provider name + SunPKCS11 prefix
//                Security.removeProvider(sunPKCS11Provider.getName());
//            Security.addProvider(sunPKCS11Provider);
//            KeyStore keystorePkcs11;
//            KeyStore.CallbackHandlerProtection callback = new KeyStore.CallbackHandlerProtection(new SimpleCallbackHandler(null,Clave)) ;
//         
//            KeyStore.Builder builder = KeyStore.Builder.newInstance(Repositorio.TOKEN, sunPKCS11Provider, callback);
//            keystorePkcs11 = builder.getKeyStore();
//            
//            KeyStore.PasswordProtection pp = new KeyStore.PasswordProtection(Clave);
//            InputStream in = getClass().getResourceAsStream(windowsDir_iKey);
//            keystorePkcs11.load(in, pp.getPassword());
//         
//            return keystorePkcs11;
//            
//         
////        }
